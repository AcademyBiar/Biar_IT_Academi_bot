...
def choice(message):
    if message.text == 'Обучение.':
        bot.send_message(message.chat.id, '<b>Обучение 📌 </b>\n'
                                          ...
                                          '\n✔️ Регистрируетесь на сайте (ссылка https://www.itbiar.com/)\n'
                                          ...
                                          '\n☑️ Выполняете практические задания, получаете обратную связь и закрепляете знания.\n'
        ...
        bot.send_message(message.chat.id, '<b>Экзамен 🛎 </b>\n'
                                          '✔️ В конце курса сдаете экзамен для проверки изученного материала на курсе.\n'
        ...
        link = types.InlineKeyboardButton(text='Бесплатный урок тут', url='https://www.itbiar.com/lesson-example')
        free_link.add(link)
